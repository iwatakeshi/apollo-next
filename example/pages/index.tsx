    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <Link href='/static'><a className={styles.link}><code className={styles.code}>/static</code></a></Link> for an example of static side rendering or{' '}
          <Link href='/server'><a className={styles.link}><code className={styles.code}>/server</code></a></Link> for example of server side rendering.
        </p>
