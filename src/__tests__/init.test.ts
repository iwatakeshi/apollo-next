...
describe('init', () => {
  ...
  it('should merge existing cache with new state', () => {
    ...
    // The merge behavior depends on deepmerge - it will merge objects
  ...
  it('should handle array merging correctly', () => {
    ...
    // With custom arrayMerge, it should filter duplicates
    expect(cache.ROOT_QUERY?.items).toBeDefined();
  });
